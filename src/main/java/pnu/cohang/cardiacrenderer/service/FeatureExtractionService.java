...
public class FeatureExtractionService {
    ...
    public void featureExtraction(String patientNumber) {
        try {
            ...
            ProcessBuilder pb = new ProcessBuilder(pythonLibPath + "/run_in_conda.sh", "python", featureExtractionPath, patientNumber);
            pb.directory(new File(pythonLibPath + "/step2-feature-extraction"));
            pb.inheritIO();
            try {
